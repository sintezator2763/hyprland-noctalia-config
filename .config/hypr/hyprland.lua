...
hl.animation({ leaf = "workspacesIn",  enabled = true, speed = 3,    bezier = "myBezier",     style = "slide" })
hl.animation({ leaf = "workspacesOut", enabled = true, speed = 3,    bezier = "myBezier",     style = "slide" })
